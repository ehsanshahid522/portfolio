      ...
      <div className="max-w-6xl mx-auto">
        ...
        {!loading && !error && data && (
          <div className="grid lg:grid-cols-3 gap-8">
            {/* Left: Profile Box */}
            <div className="lg:col-span-1 bg-[#111111] dark:bg-[#111111] rounded-2xl p-6 shadow-lg border border-[#2b2b2b]">
              ...
              <a
                ...
                className="mt-8 w-full text-center bg-[#2ea043] text-white font-bold px-4 py-3 rounded-xl hover:opacity-90 transition-all flex items-center justify-center gap-2"
              >
            ...
            <div className="lg:col-span-2 space-y-8">
              {/* Stats Image */}
              <div className="bg-[#111111] dark:bg-[#111111] rounded-2xl p-6 shadow-lg border border-[#2b2b2b]">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                {data.topRepos && data.topRepos.map((repo) => (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="bg-[#111111] dark:bg-[#111111] p-4 rounded-xl shadow-md border border-[#2b2b2b] hover:border-[#2ea043] transition-all group"
                  >
        ...
        <div className="bg-[#111111] dark:bg-[#111111] rounded-2xl p-6 shadow-lg border border-[#2b2b2b]">
          ...
          <div className="overflow-x-auto">
            <img
              ...
              className="w-full min-w-[700px] h-auto filter grayscale-[0.2] brightness-110"
              loading="lazy"
            />
          </div>
